...
def build_terrain(
    ...
    Args:
        ...
        base_elevation: 2D array of elevation from ETOPO/GEBCO (meters, positive up).
        ...
        resolution_m: Target resolution in meters (for reference, actual
            resolution is determined by grid_size and bbox extent).
